...
class __TwigTemplate_2c6e3039f5a8aa9420c03c96ced36aaf extends Template
{
...
";
    ...
    {
        return array (  129 => 18,  125 => 17,  119 => 14,  115 => 13,  109 => 10,  105 => 9,  100 => 6,  87 => 5,  64 => 3,  41 => 1,);
    }
...
{% block body %}
    ...
    <h2>Gestion des Utilisateurs</h2>
    <a href=\"{{ path('user_index') }}\">Voir tous les utilisateurs</a>
    <a href=\"{{ path('user_new') }}\">Ajouter un utilisateur</a>

    <h2>Gestion des Posts</h2>
    <a href=\"{{ path('article_index') }}\">Voir tous les articles</a>
    <a href=\"{{ path('article_new') }}\">Ajouter un article</a>

    <h2>Gestion des Posts</h2>
    <a href=\"{{ path('article_index') }}\">Voir tous les articles</a>
    <a href=\"{{ path('article_new') }}\">Ajouter un article</a>
{% endblock %}", "admin/dashboard.html.twig", "/Applications/MAMP/htdocs/Projects/EduLink/templates/admin/dashboard.html.twig");
    }
}
