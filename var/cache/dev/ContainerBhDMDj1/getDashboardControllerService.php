...
class getDashboardControllerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->setContainer(($container->privates['.service_locator.mV6ntiS'] ?? $container->load('get_ServiceLocator_MV6ntiSService'))->withContext('App\\Controller\\Admin\\DashboardController', $container));
